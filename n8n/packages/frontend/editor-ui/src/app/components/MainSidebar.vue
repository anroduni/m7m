...
.sideMenu {
	...
	background: linear-gradient(180deg, rgba(178, 223, 219, 0.15) 0%, rgba(224, 242, 254, 0.25) 50%, rgba(128, 203, 196, 0.1) 100%), var(--menu--color--background, var(--color--background--light-2));
