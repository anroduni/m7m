...
.node {
	...
	box-shadow: 0 4px 16px rgba(0, 150, 136, 0.08), 0 1px 4px rgba(0, 77, 64, 0.06);
	transition: box-shadow 0.3s ease, transform 0.2s ease;

	&:hover {
		box-shadow: 0 6px 24px rgba(0, 150, 136, 0.15), 0 2px 8px rgba(0, 77, 64, 0.1);
...
.waiting::after {
	...
	background: conic-gradient(
		...
		rgba(0, 150, 136, 1),
		rgba(0, 150, 136, 1) 20%,
		rgba(0, 150, 136, 0.2) 35%,
		rgba(0, 150, 136, 0.2) 65%,
		rgba(0, 150, 136, 1) 90%,
		rgba(0, 150, 136, 1)
	);
}
